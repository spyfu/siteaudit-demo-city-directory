...
$expectedRepository = 'spyfu/siteaudit-demo-city-directory'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-city-directory.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-city-directory.git'
