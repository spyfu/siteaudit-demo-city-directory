...
| --- | --- | --- | --- |
| `demo-01` | `siteaudit-demo-city-directory` | https://siteaudit-demo-city-directory.pages.dev/ | https://github.com/spyfu/siteaudit-demo-city-directory/edit/demo-01/siteaudit-head.html |
| `demo-02` | `siteaudit-demo-city-directory-02` | https://siteaudit-demo-city-directory-02.pages.dev/ | https://github.com/spyfu/siteaudit-demo-city-directory/edit/demo-02/siteaudit-head.html |
| `demo-03` | `siteaudit-demo-city-directory-03` | https://siteaudit-demo-city-directory-03.pages.dev/ | https://github.com/spyfu/siteaudit-demo-city-directory/edit/demo-03/siteaudit-head.html |
| `demo-04` | `siteaudit-demo-city-directory-04` | https://siteaudit-demo-city-directory-04.pages.dev/ | https://github.com/spyfu/siteaudit-demo-city-directory/edit/demo-04/siteaudit-head.html |
| `demo-05` | `siteaudit-demo-city-directory-05` | https://siteaudit-demo-city-directory-05.pages.dev/ | https://github.com/spyfu/siteaudit-demo-city-directory/edit/demo-05/siteaudit-head.html |
...
```powershell
git clone https://github.com/spyfu/siteaudit-demo-city-directory.git
Set-Location siteaudit-demo-city-directory
